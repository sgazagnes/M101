...
if strmatch(gal, 'REG9') eq 1 then mwlines = [mwlines, 1298, 1308, 1538.]
...
printf, lun, '# # The fit was only made from 1240-2200, while masking out between 1298, 1308, 1538.A. Be skeptical of the fit outside of these wavelengths.'
