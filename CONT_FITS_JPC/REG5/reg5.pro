...
z = 0.00057190633-105.000/cspeed
...
if strmatch(gal, 'REG5') eq 1 then mwlines = [mwlines, 1305., 1307.]
...
plot, s.wave, s.flux, xr = [1600, 1700], yr = [0, 2], thick = 2
djs_oplot, s.wave[chisreg], s.flux[chisreg], color = 'green'
djs_oplot, s.wave, cfit_super, color = 'blue', thick = 2
...
plot, s.wave, s.flux, xr = [1700, 1800], yr = [0, 2]
djs_oplot, s.wave, cfit_super, color = 'blue', thick = 2

print, c_super_mods.ebv
...
printf, lun, '# # The fit was only made from 1240-2200, while masking out between  1645, 1647. A. Be skeptical of the fit outside of these wavelengths.'
