...
if strmatch(gal, 'REG7') eq 1 then mwlines = [mwlines, 1331]
...
!p.multi = [0, 1, 2]
plot, s.wave, s.flux, xr = [140, 1575], yr = [0, 2], thick = 2
djs_oplot, s.wave[chisreg], s.flux[chisreg], color = 'green'
...
printf, lun, '# # The fit was only made from 1240-2200, while masking out between 1331A. Be skeptical of the fit outside of these wavelengths.'
