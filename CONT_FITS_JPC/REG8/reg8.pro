...
if strmatch(gal, 'REG8') eq 1 then mwlines = [mwlines, 1412., 1638., 1648]
...
chisreg = where(mask eq 1  and s.wave gt 1300. and s.wave lt 2000 and finite(s.flux) eq 1 and s.err ne 0, comp = badc)
...
printf, lun, '# # The fit was only made from 1240-2200, while masking out between 1412., 1638., 1648A. Be skeptical of the fit outside of these wavelengths.'
