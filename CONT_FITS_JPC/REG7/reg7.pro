...
if strmatch(gal, 'REG6') eq 1 then mwlines = [mwlines, 1635, 1646]
...
chisreg = where(mask eq 1  and s.wave gt 1300. and s.wave lt 1930 and finite(s.flux) eq 1 and s.err ne 0, comp = badc)
...
printf, lun, '# # The fit was only made from 1240-2000, while masking out between 1635, 1646A. Be skeptical of the fit outside of these wavelengths.'
